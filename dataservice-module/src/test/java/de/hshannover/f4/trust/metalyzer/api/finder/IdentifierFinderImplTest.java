...
public class IdentifierFinderImplTest {
	...
	public void testGetCurrentIdentifierWithoutFilters() {
		...
		// thenUnfilteredCurrentIdentifierListShouldBe(); Auskommentiert da
		// Testen von Arrays zur Zeit nicht geht.
	}
	...
	private void thenUnfilteredCurrentIdentifierListShouldHaveSize() {
		assertEquals("Returns an unfiltered current Identifier list",
				expectedIdentifiers.size(), identifiers.size());
	}
	...
	private void whenGetCurrentIdentifierIsCalledWithFilter(
			StandardIdentifierType filter) {
		try {
	...
	private void thenFilteredCurrentIdentifierListShouldHaveSize() {
		assertEquals(
				"Tests if the returned List has the right size() filtered by Device",
				2, identifiers.size());
	}

	@Test
	public void testGetIdentifiersFilteredByIpaddressAtTimestamp()
	...
	private void thenIdentifierListShouldHaveSize() {
		assertEquals(
				"Tests if the returned List has the right size() filtered by IP_Address",
				2, identifiers.size());
	}
	...
	public void testGetCurrentIdentifierWithFilterNull()
			throws MetalyzerAPIException {
	...
	public void testGetIdentifierWithTimestampNegative()
			throws MetalyzerAPIException {
		givenEmptyMockService();
	...
	@Test(expected = NegativeTimestampException.class)
	public void testGetIdentifierDeltaWithNegativeTimestamp()
			throws MetalyzerAPIException {
		givenEmptyMockService();
	...
	public void testGetIdentifierDeltaWithImpossibleDelta()
			throws MetalyzerAPIException {
		givenEmptyMockService();
	...
	@Test(expected = NoFilterException.class)
	public void testGetIdentifierDeltaWithNullFilter()
			throws MetalyzerAPIException {
		givenEmptyMockService();
