...
public class TestGraphBuilder {
	...
	private void buildAR10() {
		...
		metas10.add(cap);
		cap.addProperty(PropertyStrings.CAP_NAME.get(), "access-server-allowed");
		...
		devAttr.addProperty(PropertyStrings.DEV_ATTR.get(), "low-disc-space");
		metas10.add(devAttr);
	...
	private void buildAR11() {
		...
		IdentifierImpl secIdent = gh.createIdentity("username",
				"Galileo Galilei");
