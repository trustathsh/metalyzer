...
public class GraphBuilderHelper {
	...
	public GraphBuilderHelper(ArrayList<Identifier> identifiers,
	...
	public IdentifierImpl createDevice(String name) {
		...
		ident.addProperty(PropertyStrings.DEVICE_NAME.get(), name);
	...
	public IdentifierImpl createIP(String type, String address) {
		...
		ip.addProperty(PropertyStrings.IP_VALUE.get(), address);
		ip.addProperty(PropertyStrings.IP_TYPE.get(), type);
	...
	public IdentifierImpl createMAC(String address) {
		...
		mac.addProperty(PropertyStrings.MAC_VALUE.get(), address);
	...
	public IdentifierImpl createIdentity(String type, String name) {
		...
		ident.addProperty(PropertyStrings.IDENT_TYPE.get(), type);
		ident.addProperty(PropertyStrings.IDENT_NAME.get(), name);
	...
	public IdentifierImpl createAR(String name) {
		...
		ar.addProperty(PropertyStrings.AR_NAME.get(), name);
	 ...
	 * @return
	 */
	public LinkImpl buildDeviceIPLink(IdentifierImpl device, IdentifierImpl ip,
			long ts) {
	 ...
	 * @return
	 */
	public LinkImpl buildIPMACLink(IdentifierImpl ip, IdentifierImpl mac,
			long ts) {
	 ...
	 * @return
	 */
	public LinkImpl buildAuthByLink(IdentifierImpl pdp, IdentifierImpl ar,
			long ts) {
	 ...
	 * @return
	 */
	public LinkImpl buildLayer2Link(IdentifierImpl ar, IdentifierImpl sw,
			long ts, String port, String vlan, String name) {
		MetadataImpl layer2 = new MetadataImpl("layer2-information", false, ts);
		metas.add(layer2);

		layer2.addProperty(PropertyStrings.LAY2_PORT.get(), port);
		layer2.addProperty(PropertyStrings.LAY2_VLAN.get(), vlan);
		layer2.addProperty(PropertyStrings.LAY2_VLAN_NAME.get(), name);
	 ...
	 * @return
	 */
	public LinkImpl buildARMACLink(IdentifierImpl ar, IdentifierImpl mac,
			long ts) {
	 ...
	 * @return
	 */
	public LinkImpl buildRoleLink(IdentifierImpl ar, IdentifierImpl identity,
			long ts, String role) {
		MetadataImpl mRole = new MetadataImpl("role", true, ts);
		mRole.addProperty(PropertyStrings.ROLE_NAME.get(), role);
		metas.add(mRole);
	 ...
	 * @return
	 */
	public LinkImpl buildARDevLink(IdentifierImpl ar, IdentifierImpl dev,
			long ts) {
