...
public class Counter {
	/**
	 * @param typeName
	 *            Typename of the Identifier, wich should be count
	 * @param list
	...
	/**
	 * @param typeName
	 *            Typename of the Metadata, wich should be count
	 * @param list
	...
	/**
	 * @param ident
	 *            List of identifiers, whose links should be counted
	 * @return Returns a list of links
	 */
	public static ArrayList<Integer> countLinksFromIdentifiers(
			Collection<Identifier> ident) {
		int value = 0;
