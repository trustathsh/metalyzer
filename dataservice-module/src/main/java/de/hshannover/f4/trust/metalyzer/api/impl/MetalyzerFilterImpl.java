 ...
 * 
 */
public class MetalyzerFilterImpl implements MetalyzerFilter, ListReturner,
		DeltaReturner {

	private static final Logger log = Logger
			.getLogger(MetalyzerFilterImpl.class);
	...
	public ArrayList<Identifier> asIdentifiers() {
		if ((time == null) || !(time.isCurrent() || time.isAt())) {
			...
			throw new FilterTimeException(
					"MetalyzerTime was not correctly set!");
		}
