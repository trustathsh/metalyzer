...
/**
 * Fluent-Interface for returning the speficied MetalyzerDelta.
 * 
 * @author Johannes Busch
 * 
 */
public interface DeltaReturner {
	/**
	 * Returns the result as a list of identifiers. Filtering of Metadata does
