...
/**
 * Implements the not filter.
 * 
 * @author Johannes Busch
 * 
 */
public class NotIdentifierFilter extends GenericElementFilter<Identifier> {
	/**
	 * Filter list.
	 */
	private HashSet<String> filter;

	public NotIdentifierFilter(HashSet<String> filter) {
		super();
		this.filter = filter;
	}

	/**
	 * Filters the given list against the internal filters. Method is
	 * implemented like a logic not filter.
	 */
	@Override
