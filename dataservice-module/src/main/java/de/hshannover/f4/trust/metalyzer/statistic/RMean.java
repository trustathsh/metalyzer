...
/**
 * @author Hassan Nahle
 * evaluate the mean of a given evaluationlist. 
 * This list should be a numerical Arraylist
 */
public class RMean extends StatisticalCalculator {
    private REvaluator rEvaluator = REvaluator.getInstance();
    private double result = 0;

    /**
     * @param evaluationList A ArrayList to evaluate the mean
     */
    public RMean(ArrayList< ? extends Number> evaluationList){
    ...
    public void evaluate(String evalString){
            ...
            REXP rexp = rEvaluator.evalInR("mean(x)");
    ...
    /**
     * 
     * @return Returns the value of mean
     **/
