...
/**
 * Fluent-Interface for returning the speficied Entity-List. Identifier and
 * Metadata are possible return types.
 * 
 * @author Johannes Busch
 * 
 */
public interface ListReturner {
	/**
	 * Returns the result as a list of identifiers.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the result as a list of metadata.
	 * 
	 * @return
	 */
