 ...
 *
 * This class provides a bunch of static label descriptions for all categories
 */
...
public class CategoryLabels {
	...
	public static final String IP = "IP-Addresses";
	public static final String MAC = "Mac-Addresses";
