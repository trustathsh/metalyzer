...
public class StatusBar extends JPanel {
	...
	private JPanel createComponent(JComponent component) {
		JPanel panelComponent = new JPanel(new FlowLayout(FlowLayout.LEADING,
				0, 0));
