...
public class ViewContainer extends View {
	 ...
	 * 
	 * @param index
	 *            the position where the view is placed e.g 1 after the TopView
	 * @param view
	 *            the view that should be added
	 **/
	 ...
	 * 
	 * @param view
	 *            the view that should be removed
	 **/
	 ...
	 * 
	 * @param views
	 *            the list of {@link Views} held by this container
	 * */
