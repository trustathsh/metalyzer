...
public class DevicePanel extends SemanticPanel {
	...
	public DevicePanel(MetalyzerGuiController guiController,
	 ...
	 * 
	 * @param ipAddressCount
	 *            the count of macaddresses of a device
	 * */
	 ...
	 * 
	 * @param ipAddressCount
	 *            the count of ipaddresses of a device
	 * */
	...
	/**
	 * @param attributes
	 *            An ArrayList that contains all attributes of a device
