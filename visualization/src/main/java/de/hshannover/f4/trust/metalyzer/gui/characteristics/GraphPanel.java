...
public class GraphPanel extends StatisticPanel {
	...
	public GraphPanel(MetalyzerGuiController guiController,
	...
	public GraphPanel(MetalyzerGuiController guiController,
			String characteristic, ChartType chart) {
		...
		mChartView.addChartAdjustmentListener(new ChartAdjustmentHandler(
				guiController, this, 10));
