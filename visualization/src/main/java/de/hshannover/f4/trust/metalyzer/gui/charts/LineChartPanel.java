...
public class LineChartPanel extends AbstractChartPanel {
	...
	public JFreeChart createChart() {
		...
		mChart = ChartFactory.createLineChart("LineChart", "X", "Y",
				mCategoryDataset, PlotOrientation.VERTICAL, false, true, false);

		mLinePlot = mChart.getCategoryPlot();
		mLinePlot.setDomainGridlinesVisible(true);

		LineAndShapeRenderer lineRenderer = (LineAndShapeRenderer) mLinePlot
				.getRenderer();
