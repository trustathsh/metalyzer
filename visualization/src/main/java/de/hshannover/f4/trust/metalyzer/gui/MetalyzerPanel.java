...
public class MetalyzerPanel extends JPanel {
	...
	private void initPanel() {
		...
		CategoryPanel frequencyCategory = new CategoryPanel(mGuiController,
				CategoryLabels.FREQUENCY);
		/* Statisitic Characteristics */
		FrequencyPanel f1 = new FrequencyPanel(mGuiController,
				CharacteristicLabels.FREQUENCY_IDENTIFER, ChartType.BAR,
				ChartType.PIE);
		f1.setInfoDescription(InfoLabels.FREQUENCY_IDENTIFER_INFO);
		f1.setPropertyNames("Identifer", "Count of Identifer",
				"Percentage of Identifer");
		f1.setValueAxisLabel("Count of Identifer");
		f1.setCategoryAxisLabel("Identifer");
		frequencyCategory.addCharacteristicPanel(f1);

		FrequencyPanel f2 = new FrequencyPanel(mGuiController,
				CharacteristicLabels.FREQUENCY_METADATA, ChartType.BAR,
				ChartType.PIE);
		f2.setInfoDescription(InfoLabels.FREQUENCY_METADATA_INFO);
		f2.setPropertyNames("Metadata", "Count of Metadata",
				"Percentage of Metadata");
		f2.setValueAxisLabel("Count of Metadata");
		f2.setCategoryAxisLabel("Metadata");
		frequencyCategory.addCharacteristicPanel(f2);

		FrequencyPanel f3 = new FrequencyPanel(mGuiController,
				CharacteristicLabels.FREQUENCY_ROLES, ChartType.BAR,
				ChartType.PIE);
		...
		// Mean Category
		CategoryPanel meanCategory = new CategoryPanel(mGuiController,
				CategoryLabels.MEAN);

		MeanPanel m1 = new MeanPanel(mGuiController,
				CharacteristicLabels.MEAN_LINKS);
		...
		// Graph Category
		CategoryPanel graphCategory = new CategoryPanel(mGuiController,
				CategoryLabels.GRAPH);

		GraphPanel g1 = new GraphPanel(mGuiController,
				CharacteristicLabels.GRAPH_NODES, ChartType.LINE);
		...
		GraphPanel g2 = new GraphPanel(mGuiController,
				CharacteristicLabels.GRAPH_EDGES, ChartType.LINE);
		...
		GraphPanel g3 = new GraphPanel(mGuiController,
				CharacteristicLabels.GRAPH_MEAN, ChartType.LINE);
		...
		mBrowserPanel.addCategoryEntry(CategoryLabels.STATISTICS,
				frequencyCategory);
		mBrowserPanel.addCategoryEntry(CategoryLabels.STATISTICS, meanCategory);
		mBrowserPanel
				.addCategoryEntry(CategoryLabels.STATISTICS, graphCategory);

		// Semantic Characteristics

		// User-Panels

		CategoryPanel userCategory = new CategoryPanel(mGuiController,
				CategoryLabels.USER);

		UserPanel u1 = new UserPanel(mGuiController,
				CharacteristicLabels.USER_IP);
		...
		UserPanel u2 = new UserPanel(mGuiController,
				CharacteristicLabels.USER_MAC);
		u2.setInfoDescription(InfoLabels.USER_MAC_INFO);
		u2.setPropertyNames("Mac-Address");
		userCategory.addCharacteristicPanel(u2);

		UserPanel u3 = new UserPanel(mGuiController,
				CharacteristicLabels.USER_DEVICES);
		...
		UserPanel u4 = new UserPanel(mGuiController,
				CharacteristicLabels.USER_AUTH);
		u4.setInfoDescription(InfoLabels.USER_AUTH_INFO);
		u4.setPropertyNames("User", "Role");
		userCategory.addCharacteristicPanel(u4);

		UserPanel u5 = new UserPanel(mGuiController,
				CharacteristicLabels.USER_ALL);
		...
		CategoryPanel ipAddressCategory = new CategoryPanel(mGuiController,
				CategoryLabels.IP);

		IpAddressPanel ip1 = new IpAddressPanel(mGuiController,
				CharacteristicLabels.IP_USER);
		ip1.setInfoDescription(InfoLabels.IP_USER_INFO);
		ip1.setPropertyNames("User", "Role");
		ipAddressCategory.addCharacteristicPanel(ip1);

		IpAddressPanel ip2 = new IpAddressPanel(mGuiController,
				CharacteristicLabels.IP_MAC);
		...
		IpAddressPanel ip3 = new IpAddressPanel(mGuiController,
				CharacteristicLabels.IP_DEVICES);
		...
		IpAddressPanel ip4 = new IpAddressPanel(mGuiController,
				CharacteristicLabels.IP_AUTH);
		...
		IpAddressPanel ip5 = new IpAddressPanel(mGuiController,
				CharacteristicLabels.IP_ALL);
		...
		// Mac-Panels
		CategoryPanel macAddressCategory = new CategoryPanel(mGuiController,
				CategoryLabels.MAC);

		MacAddressPanel mac1 = new MacAddressPanel(mGuiController,
				CharacteristicLabels.MAC_USER);
		...
		MacAddressPanel mac2 = new MacAddressPanel(mGuiController,
				CharacteristicLabels.MAC_IP);
		...
		MacAddressPanel mac3 = new MacAddressPanel(mGuiController,
				CharacteristicLabels.MAC_DEVICES);
		...
		MacAddressPanel mac4 = new MacAddressPanel(mGuiController,
				CharacteristicLabels.MAC_AUTH);
		...
		MacAddressPanel mac5 = new MacAddressPanel(mGuiController,
				CharacteristicLabels.MAC_ALL);
		mac5.setInfoDescription(InfoLabels.MAC_ALL_INFO);
		mac5.setPropertyNames("User", "Role", "IP-Address", "IP-Version",
				"Device");
		macAddressCategory.addCharacteristicPanel(mac5);

		// Dev-Panels
		CategoryPanel deviceCategory = new CategoryPanel(mGuiController,
				CategoryLabels.DEVICE);

		DevicePanel dev1 = new DevicePanel(mGuiController,
				CharacteristicLabels.DEVICE_USER);
		...
		DevicePanel dev2 = new DevicePanel(mGuiController,
				CharacteristicLabels.DEVICE_IP);
		...
		DevicePanel dev3 = new DevicePanel(mGuiController,
				CharacteristicLabels.DEVICE_MAC);
		...
		DevicePanel dev4 = new DevicePanel(mGuiController,
				CharacteristicLabels.DEVICE_AUTH);
		...
		DevicePanel dev5 = new DevicePanel(mGuiController,
				CharacteristicLabels.DEVICE_ALL);
		dev5.setInfoDescription(InfoLabels.DEVICE_ALL_INFO);
		dev5.setPropertyNames("User", "Role", "IP-Address", "IP-Version",
				"Mac-Address");
		deviceCategory.addCharacteristicPanel(dev5);

		mBrowserPanel.addCategoryEntry(CategoryLabels.SEMANTICS, userCategory);
		mBrowserPanel.addCategoryEntry(CategoryLabels.SEMANTICS,
				ipAddressCategory);
		mBrowserPanel.addCategoryEntry(CategoryLabels.SEMANTICS,
				macAddressCategory);
		mBrowserPanel
				.addCategoryEntry(CategoryLabels.SEMANTICS, deviceCategory);
	 ...
	 *            of the new tab
	 * @param comp
	 *            {@link CategoryPanel} child component of the tab
	 * */
