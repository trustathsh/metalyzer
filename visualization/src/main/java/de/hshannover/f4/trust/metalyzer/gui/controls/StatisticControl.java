...
public abstract class StatisticControl implements Control {
	...
	/**
	 * Updates the given {@link StatisticPanel} to adjust the scroll area that
	 * is modified by the {@link ChartAdjustmentHandler}
	 * 
	 * @param statisticPanel
	 *            the panel that should be updated e.g. {@link GraphPanel}
	 * @param lowerBoundary
	 ...
	 *            depends on the scroll range
	 * */
	public abstract void updateChartScrollArea(StatisticPanel statisticPanel,
