...
public class ItemSelectionHandler implements ActionListener {
	...
	private MetalyzerGuiController mGuiControl;
	private SemanticPanel mSemanticPanel;

	public ItemSelectionHandler(MetalyzerGuiController guiControl,
			SemanticPanel semanticPanel) {
		mGuiControl = guiControl;
		mSemanticPanel = semanticPanel;
	}

	/**
	 * Triggers a ActionEvent, which fills the {@link SemanticPanel} according
	 * to the selected user of the drop down menu
	 */
	@Override
	public void actionPerformed(ActionEvent e) {
		...
		if (comboBox != null) {
			...
			mGuiControl.updateAnalysePanels(mSemanticPanel, item);
		}
	}
