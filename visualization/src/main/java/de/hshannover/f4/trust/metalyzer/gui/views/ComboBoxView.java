...
public class ComboBoxView<T> extends View {
	...
	/**
	 * Adds a ActionListener to the ComboBoxView, that is triggered when an item
	 * is selected
	 * 
	 * @param listener
	 *            of the ComboBoxView combobox
	 * */
	 ...
	 * 
	 * @param item
	 *            that will be added to the combobox
