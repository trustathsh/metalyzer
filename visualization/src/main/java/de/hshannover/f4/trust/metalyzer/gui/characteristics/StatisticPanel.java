...
public class StatisticPanel extends AnalysePanel {
	...
	public StatisticPanel(MetalyzerGuiController guiController,
			String characteristic, boolean chartEnabled) {
	 ...
	 * 
	 * @param columnIndex
	 *            the index of the column of where the precision is applied to.
	 * @param minPrecsion
	 *            the minimal digit fraction
	 * @param maxPrecsion
	 *            the maximal digit fraction
	 * @see NumberFormat
	 * */
	public void setPropertyPrecsion(int columnIndex, int minPrecsion,
			int maxPrecsion) {
	 ...
	 *            the maximal digit fraction
	 * */
	public void setPropertyPercantage(int columnIndex, int minPrecsion,
			int maxPrecsion) {
		Locale loacale = Locale.getDefault();
	...
	/**
	 * Clears the properties table and the chart values if available
	 */
	@Override
