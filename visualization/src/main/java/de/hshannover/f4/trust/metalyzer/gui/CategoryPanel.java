...
public class CategoryPanel extends JPanel {
	...
	public CategoryPanel(MetalyzerGuiController guiController, String category) {
		...
		this.setPreferredSize(new Dimension(
				mGuiController.getViewWidth() - 400, mGuiController
						.getViewHeight() - 200));
	...
	/**
	 * Returns the related category of this CategoryPanel e.g. "Mean" of
	 * "Frequency" for more information of the currently available categories
	 * see {@link CategoryLabels}
	 * 
	 * @return category
	 * */
	 ...
	 */
	public void setCharacteristicHandler(
			CharacteristicSelectionHandler selectionHandler) {
	...
	/**
	 * Returns the current selected characteristic, e.g "Mean of Links" of
	 * "Frequency of Metadata" for more information of the currently available
	 * categories see {@link CharacteristicLabels}
	 * 
