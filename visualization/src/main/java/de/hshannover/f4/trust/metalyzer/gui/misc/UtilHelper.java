...
public class UtilHelper {
	...
	/**
	 * Creates a dummy list, with two long timestamps, which is be used for the
	 * {@link SpinnerListModel}. This model needs a non-null array list in order
	 * to work.
	 * 
	...
	/**
	 * Converts a unixtimestamp into a date formatted String (yyyy-MM-dd
	 * HH:mm:ss) and returns it
	 * 
	 * @param loginTimestamp
	 *            Unixtimestamp of the first login of a User
	...
	public static String convertTimestampToDatestring(long loginTimestamp) {
		...
		Date firstLoginDate = new Date(loginTimestamp);
		return df.format(firstLoginDate);
	}

	/**
	 * Retuns a String reprensentaion of the number, formated according to the
	 * precision
	 * 
	 * @param minPrecsion
	 * @param maxPrecsion
	 * @see NumberFormat
	 * */
	public static String getPrecsion(double value, int minPrecsion,
			int maxPrecsion) {
