 ...
 * 
 */
public class FrequencyPanel extends StatisticPanel {

	private static final long serialVersionUID = 1L;

	public FrequencyPanel(MetalyzerGuiController guiController,
			String characteristic, ChartType relativeType,
			ChartType absoluteType) {
		super(guiController, characteristic, true);
		mChartView.addChart(0, relativeType);
		mChartView.addChart(1, absoluteType);
