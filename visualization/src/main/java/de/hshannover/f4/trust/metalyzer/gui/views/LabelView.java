...
public class LabelView extends View {
	...
	/**
	 * Creates a TextLabel with given parameters and adds it to the
	 * TextLabelView
	 * 
	 * @param id
	 *            the label id of the TextLabel
	 * @param description
	 *            the text of the label, that describes the value
	 * @param value
	 *            a numeric value, that is displayed by the label
	 * @see TextLabel
	 * */
	 ...
	 *            the text of the label, that describes the value
	 * @param value
	 *            a text value, that is displayed by the label
	 * @see TextLabel
	 * */
	public void addLabel(String id, String description, String value) {
		...
		layout.row().center().indent(mViewIndent).add(mTextDescription)
				.add(mTextValue);
	}
	...
	class TextLabel {
		...
		@Override
		public String toString() {
			return "Desc: " + mDescription.getText() + ", Value:"
					+ mValue.getText();
		}
	}
}
